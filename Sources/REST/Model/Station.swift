...
extension RadioBrowser.Station: Decodable {
...
extension RadioBrowser.Station: Encodable {
...
extension RadioBrowser.Station: Equatable {
    public static func == (lhs: RadioBrowser.Station, rhs: RadioBrowser.Station) -> Bool {
        return lhs.id == rhs.id
    }
}

extension RadioBrowser.Station: Hashable {
